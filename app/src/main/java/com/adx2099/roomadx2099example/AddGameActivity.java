    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(intent != null && intent.hasExtra(EXTRA_GAME_ID)){
            ...
            if(mGameId == DEFAULT_GAME_ID){
                ...
                AddGameViewModelFactory factory = new AddGameViewModelFactory(mDb,mGameId);
                final AddGameViewModel viewModel = ViewModelProviders.of(this, factory).get(AddGameViewModel.class);
                viewModel.getGame().observe(this, new Observer<GameEntry>() {
                    @Override
                    public void onChanged(GameEntry gameEntry) {
                        viewModel.getGame().removeObserver(this);
                        populateUI(gameEntry);
                    }
                });
            }
        }
