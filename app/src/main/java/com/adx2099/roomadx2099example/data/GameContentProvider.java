...
import static com.adx2099.roomadx2099example.data.GameContract.GameEntry.TABLE_NAME;
...
public class GameContentProvider extends ContentProvider {
    ...
    public static UriMatcher buildUriMatcher() {
        ...
        uriMatcher.addURI(GameContract.AUTHORITY, GameContract.PATH_GAMES + "/#", TASK_WITH_ID);
